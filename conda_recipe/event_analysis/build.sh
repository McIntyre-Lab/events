...
curl -sL https://github.com/McIntyre-Lab/events/archive/v1.0.10.tar.gz | tar xz

echo "Installing Event Analysis dependencies ..."
$PYTHON ./events-1.0.10/setup.py install --single-version-externally-managed --record=record.txt  # Python command to install the script.
