...
FRAGCOUNTS=$PROJ/counts/coverage_counts_fragments_simulation1

## Path to directory of exonic region coverage counts
FUSCOUNTS=$PROJ/counts/coverage_counts_fusions_simulation1

## Path to directory of intron coverage counts
INTCOUNTS=$PROJ/counts/coverage_counts_introns_simulation1

## Path to directory of junction coverage counts
JUNCCOUNTS=$PROJ/counts/coverage_counts_splicing_simulation1
...
OUTDIR=${PROJ}/output_simulation1
echo $OUTDIR
